...
const BluetoothMenu = ({ref, openWindow, toggleBluetoothOpen}) => {
  ...
  return (
    <div ref={ref} className='bg-[#252427] z-[55] backdrop-filter backdrop-blur-lg bg-opacity-60 flex-col p-2 flex w-72 absolute top-[28px] right-0 border border-[#4d494c] rounded-md shadow-lg'>
