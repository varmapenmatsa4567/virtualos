...
const Note = ({isSelected, onClick, dateModified, content, isBlur}) => {
  ...
  return (
    <div onClick={onClick} className={`flex px-5 py-2 text-[13px] font-semibold flex-col ${isSelected ? isBlur ? "bg-[#484746]" : "bg-[#a0812b]" : null} text-white p-2 rounded-md`}>
